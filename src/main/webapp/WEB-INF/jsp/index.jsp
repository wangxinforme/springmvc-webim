...
<body>
	...
	<form name="userForm" style="background-color: #fcfcfc; width: 100%;">
		userName：<input type="text" name="userName" value="boy" /> password：<input type="password" name="password" value="boy" /> register: <input type="checkbox" name="register" /> sendTo： <input type="text" id="to" name="to" value="hoojo" width="10" /> <input
			type="button" value="Login" id="login" />
	</form>
	<!-- 新窗口聊天 -->
	<div id="newConn" style="display: none; background-color: #fcfcfc; width: 100%;">
		User：<label></label> sendTo： <input type="text" id="sendTo" value="hoojo" width="10" /> <input type="button" value="new Chat" id="newSession" /> <input type="button" value="Logout" id="logout" />
	</div>
	<!-- 日志信息 -->
